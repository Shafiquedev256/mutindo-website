      ...
      <div className='flex flex-col   font-medium'>
        <div className='flex flex-col w-[100%]   font-medium justify-center space-y-4 items-center'>
          <h1 className='text-4xl md:text-5xl text-center font-bold my-5'>
            AB
            <span className='border-0 border-b-2 border-b-purple-700'>OU</span>T
          ...
          <div className=' hidden md:block md:p-[2rem]'></div>
        </div>

        <div className='md:grid md:grid-cols-2 my-5 md:gap-5'>
          <div className=' py-5 rounded-md md:bg-white flex flex-col font-medium justify-center items-center w-[100%]'>
          ...
          <div className=' hidden md:block md:p-[3rem]'></div>
          <div className=' hidden md:block md:p-[3rem] md:w-[30%]'></div>
          <div className='flex  flex-col justify-center items-center'>
            <div className=' py-2 text-xl text-center font-bold my-5 relative w-fit'>
              <span className=' border-0 border-t-2 border-t-purple-600  p-2 absolute top-0 left-0'></span>
              <span className='ml-2  border-0 border-b-2 border-b-purple-600  p-2 absolute bottom-0 right-0'></span>
              What We Do
            </div>
            <p className='text-sm text-center md:bg-white p-2 rounded-md py-4 md:my-4 w-[80%] font-mono'>
